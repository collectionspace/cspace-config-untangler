...
* The Botanical Garden domain profile is no longer supported as a community profile, starting with CollectionSpace 9.0.0
...
* Data Toolkit-style ingest format mappers and templates (PR#221)
...
* Use Ruby 3.4.1
* Conditionally load CHIA-related gems for lyrasis staff only
* Use CHIA for credentials
