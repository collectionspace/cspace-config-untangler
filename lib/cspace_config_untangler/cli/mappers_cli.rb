...
module CspaceConfigUntangler
  module Cli
    class MappersCli < Thor
      ...
      desc "validate",
        "Prints to screen a validation report of the JSON mappers in a directory"
      long_desc <<-LONGDESC
    ...
    Currently the validation checks for:
      ...
      LONGDESC
      option :input,
        desc: "Path to input directory containing JSON mappers. Will be traversed recursively", default: "data/mappers", aliases: "-i"
      def validate
