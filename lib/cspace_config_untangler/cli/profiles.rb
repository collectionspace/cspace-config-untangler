...
module CspaceConfigUntangler
  module Cli
    class Profiles < SubcommandBase
      ...
      long_desc <<~LONGDESC
        Requires two (and only two) profiles be specified with -p/--profile
        option:
        ...
        The filename for the above will be:
        `compare_core_6_1_0_to_anthro_4_1_2.csv`.

        You will find the csv file in the output directory you
        specified, or in the default directory shown above if you did
        not specify an output location. Examples of specifying custom
        output location below. Either form will work:
